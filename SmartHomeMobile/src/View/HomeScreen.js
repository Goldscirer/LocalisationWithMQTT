  ...
  render() {
    return (
      <View>
        ...
        <ScrollView>
          <Button name={'CLOSE GATE'} onPress={() => closeGate()} />
          <Button name={'OPEN GATE'} onPress={() => openGate()} />
          <Button name={'OPEN GARAGE'} onPress={() => closeGarage()} />
          <Button name={'CLOSE GARAGE'} onPress={() => openGarage()} />
          <View style={{ marginTop: 50 }}>
            ...
            <Text style={styles.cardStyle}>Pressure: 45.63 [hPa]</Text>
            <Text style={styles.cardStyle}>Humidity: 45.63%</Text>
          </View>
        </ScrollView>
      </View>
    );
